...
#### Preamble ####
# Purpose: Clean the TTC Subway Delay dataset and save the cleaned data for 
#          further analysis
# Author: Weiyang Li
...
# License: MIT
# Pre-requisites: 
#   - Ensure that the dataset "raw_data.csv" is available in the folder 
#     'data/raw_data/'
#   - Installed R packages: tidyverse, janitor
#   - The working directory is set up to contain the required folders: 
#     'data/analysis_data' for saving the cleaned output.
# Additional Information: 
#   - The script performs two stages of data cleaning: initial cleaning and 
#     further filtering of delays.
#   - The cleaned datasets are saved as "cleaned_ttc_data.csv" and 
#     "cleaned_delay_data.csv" in the 'analysis_data' folder.
