...
#### Preamble ####
# Purpose: Downloads and saves the data from Open Data Toronto for TTC Subway 
#          Delay Analysis
# Author: Weiyang Li
...
#   - Ensure the working directory has a 'data/raw_data' folder or path for 
#     saving the data
# Additional Information: 
#   - Dataset fetched: TTC Subway Delay data 
#                      (ID: 2ee1a65c-da06-4ad1-bdfb-b1a57701e46a)
